        ...
        public static void SeedDatabase(WardrobeDBContext context)
        {
            if (!context.ClothingItems.Any())
            {
                context.ClothingItems.AddRange(
                    ...
                    new Models.ClothingItem()
                    { Id = 4, ImageId = 3, UserId = 2, Name = "My Red Jacket", Brand = "Supreme", Category = Models.Enums.ClothingCategory.Coat, Colour = "#C90505", Occasion = Models.Enums.Occasion.Formal, Season = Models.Enums.Season.Winter, Size = Models.Enums.ClothingSize.M },
                    new Models.ClothingItem()
                    { Id = 5, ImageId = 3, UserId = 2, Name = "My Red Jacket", Brand = "Supreme", Category = Models.Enums.ClothingCategory.Coat, Colour = "#C90505", Occasion = Models.Enums.Occasion.Formal, Season = Models.Enums.Season.Winter, Size = Models.Enums.ClothingSize.M },
                    new Models.ClothingItem()
